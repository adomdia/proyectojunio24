...
class InstaladorCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'playtogether:install';
     ...
     * @var string
     */
    protected $description = 'Instalacion simplificada marca PlayTogether';
    ...
    protected function getUser($create = false)
    {
        ...
        if ($create) {
            $name = 'PlayTogether';//$this->ask('Enter the admin name');
