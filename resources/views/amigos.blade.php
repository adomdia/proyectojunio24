...
<div class="container mt-5" style="padding-top: 50px">
    ...
    <div class="row">
            ...
            <div class="card" style="max-width: 260px">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{route('chat', $usuario->id)}}" style="text-decoration: none">
                            <button class="btn btn-primary ml-3 text-white" data-userid="{{ $usuario->id }}">Abrir Chat
                            </button>
                        </a>
        ...
        <div class="page-component__wrapper" style="z-index: 11;padding-top:150px;padding-bottom:70px;display:flex;justify-content:center">
            ...
            <h2 style="color:black">Todavía no has creado ninguna amistad</h2>
