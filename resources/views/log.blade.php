                    ...
                    <div class="cta_form-01__wrapper">
                        ...
                        <div class="container container--small">
                            <div class="title-box title-box--center">
                                ...
                                <h1 class="heading ">Accede con tu correo y contraseña</h1>
                        ...
                        <div class="cta_form-01__form_box">
                            ...
                            <form class="form  form--centered-button" action="{{route('login')}}" method="POST"
                                data-sheet-id="">
                                @csrf
                    ...
                    <div class="cta_form-01__wrapper">
                        ...
                        <div class="container container--small">
                            <div class="title-box title-box--center">
                                ...
                                <a href="{{route('validar_code')}}" target="_self">
                                <button class="button" style="background-color:#fff;color:#3f969d"><span
                                    class="button__text">Validar código</span>                               
                            </button>
