                    ...
                    <div class="cta_form-01__wrapper">
                        ...
                        <div class="container container--small">
                            <div class="title-box title-box--center">
                                ...
                                <h1 class="heading ">Verificación de código SMS</h1>
                        ...
                        <div class="cta_form-01__form_box">
                            ...
                            <form class="form  form--centered-button" action="{{route('validar')}}" method="POST"
                                data-sheet-id="">
                                @csrf
                                ...
                                <div class="form__inputs">
                                    ...
                                    <div class="form__input  form__input--full  ">
                                        ...
                                        <input class="text-input js-form-input   " type="text" id="FNAME-85500-1"
                                            name="code" required placeholder="Escriba el código recibido" />
                                    </div>
